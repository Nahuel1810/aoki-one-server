...
test("no cruza de lado: ignora slots del lado opuesto", () => {
  ...
  const slots = [
    { id: "left-1", locationCode: "3X01AE1", status: "LIBRE" },
    { id: "right-1", locationCode: "3X02AE1", status: "LIBRE" },
  ];
...
test("prioriza mismo nivel para evitar elevador", () => {
  ...
  const slots = [
    { id: "other-level", locationCode: "3X02AD3", status: "LIBRE" },
    { id: "same-level", locationCode: "3X02AE3", status: "LIBRE" },
  ];
...
test("si no hay mismo nivel, minimiza distancia vertical y luego horizontal", () => {
  ...
  const slots = [
    { id: "lvl-3-mod-2", locationCode: "3X02AC3", status: "LIBRE" }, // nivel diff 2
    { id: "lvl-4-mod-6", locationCode: "3X06AD1", status: "LIBRE" }, // nivel diff 1
    { id: "lvl-4-mod-2", locationCode: "3X02AD1", status: "LIBRE" }, // nivel diff 1, modulo mas cerca
  ];
...
test("prioriza posiciones 1 -> 2 -> 3", () => {
  ...
  const slots = [
    { id: "pos-1", locationCode: "3X02AE1", status: "LIBRE" },
    { id: "pos-2", locationCode: "3X02AE2", status: "LIBRE" },
    { id: "pos-3", locationCode: "3X02AE3", status: "LIBRE" },
  ];
...
test("prioriza posiciones 1 -> 2 -> 3 para cualquier nivel", () => {
  ...
  for (const level of levels) {
    ...
    const slots = [
      { id: `${level}-pos-3`, locationCode: `3X02A${level}3`, status: "LIBRE" },
      { id: `${level}-pos-1`, locationCode: `3X02A${level}1`, status: "LIBRE" },
      { id: `${level}-pos-2`, locationCode: `3X02A${level}2`, status: "LIBRE" },
    ];
...
test("solo considera slots libres", () => {
  ...
  const slots = [
    ...
    { id: "LIBRE", locationCode: "3X02AE2", status: "LIBRE" },
  ];

  const best = selectNearestPickSlot(source, slots);

  assert.equal(best.id, "LIBRE");
